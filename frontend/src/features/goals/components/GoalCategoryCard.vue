...
import CreateGoalForm from "@/features/goals/forms/CreateGoalForm.vue";
import CreateGoalButton from "./CreateGoalButton.vue";
import { Menu, MenuButton, MenuItems, MenuItem } from "@headlessui/vue";
import { Text, Box, InputField } from "@/shared/components/ui";
...
const { mutate: updateCategory } = useUpdateGoalCategory();
const { mutate: deleteCategory } = useDeleteGoalCategory();
